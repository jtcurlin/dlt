...
from dlt.sources.filesystem import FileItemDict, filesystem, read_csv_duckdb
...
def test_read_csv_duckdb_interleaved_readers(tmp_path: pathlib.Path, use_pyarrow:
bool) -> None:
